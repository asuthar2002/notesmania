...
import "./UILoading.css"; // Assuming styles are in this CSS file

const UILoading = ({ size = 100, color = "#3b82f6", label = "Loading..." }) => {
  return (
    <div className="flex w-full h-full flex-col items-center justify-center">
      ...
      {label && <p className="mt-4 text-sm text-gray-600 animate-pulse">{label}</p>}
    </div>
  );
};
