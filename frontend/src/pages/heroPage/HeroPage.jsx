...
const HeroPage = () => {
  return (
    <>
      <section className="relative mt-5 clip-polygon rounded-xl overflow-hidden " style={{ backgroundColor: "#1f2937" }}>
        <img
        ...
        />
        <div className="absolute inset-0 flex flex-col justify-center max-w-7xl mx-auto px-6 sm:px-10 md:px-16 lg:px-24 xl:px-10" style={{ maxWidth: 1920 }}>
          <div className="flex flex-col items-center justify-center min-h-screen px-4 md:flex md:flex-col  md:items-start md:justify-center ">
            <span className="inline-flex items-center bg-white rounded-full px-3 py-1 mb-4 text-sm font-semibold text-gray-800" style={{ maxWidth: "fit-content" }}>
              <span className="bg-[#00b37e] text-white rounded-full px-2 py-0.5 mr-2 font-semibold text-xs leading-none">New</span>
